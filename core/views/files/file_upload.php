      ...
      <div class="col-lg-8 offset-lg-2">
        <form action="#" method="post" enctype="multipart/form-data">
          <div class="form-group">
            <label>File</label>
            <div>
              <input name="files[]" id="fileInput" max="5" min="1" multiple class="form-control" type="file">
          ...
          <div class="form-group">
            ...
            <div>
              <input name="url" onchange="previewLink(this)" class="form-control" type="url">
              <small class="form-text text-muted">Max. file size: 50 MB.</small>
            </div>
            <div class="row" id="previewurl">
            </div>
          </div>
  ...
  <div class="notification-box">
    <script type="application/javascript">
      ...
      function previewLink(evt) {
        const pre = document.getElementById("previewurl");
        if(pre !== null)
        {
          pre.innerHTML = image(evt.value);
        }
      }
    </script>
  </div>
